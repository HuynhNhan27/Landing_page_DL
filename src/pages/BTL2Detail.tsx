...
const BTL2Detail = () => {
  const exercises = [
    ...
    },
    {
      ...
      link: "/btl2/exercise3",
      topics: ["Preprocessing", "Deep Learning", "Evaluation"],
    },
  ];
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-primary">
            BTL 2 - Advanced ML & Deep Learning
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Nâng cao kỹ năng học máy bằng cách làm việc với các mô hình học sâu và kỹ thuật xử lý dữ liệu
            phức tạp. Bài tập được chia thành 3 phần để đảm bảo hiểu sâu từng khía cạnh.
          </p>
        </div>
